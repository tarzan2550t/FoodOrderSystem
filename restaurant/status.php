...
<nav class="navbar navbar-dark">
    ...
    <div class="content">
        <a href="order.php" class="btn btn-primary mb-2"><i class="bi bi-arrow-left"></i></a>
    ...
    <a href="order.php"class="btn btn-success">ยืนยันสินค้าสำเร็จ</a>
    <a href="MPDF.php?id=<?=$id?>"class="btn btn-success">ปริ้นใบเสร็จ</a>
