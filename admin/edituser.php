...
<body>
    <div class="login-card">
        <h3 class="text-center mb-4">แก้ไขข้อมูล ลูกค้า</h3>
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text"  name="Fname" class="form-control" placeholder="" value="<?=$row['Fname'];?>"required>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">นามสกุล</label>
                <input type="text"  name="Lname" class="form-control" placeholder=""value="<?=$row['Lname'];?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text"  name="pass" class="form-control" placeholder="" value="<?=$row['password'];?>"required>
            </div>
            <div class="mt-4">
