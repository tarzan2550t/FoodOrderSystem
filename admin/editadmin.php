...
<body>
    <div class="login-card">
        <h3 class="text-center mb-4">แก้ไขข้อมูล แอดมิน</h3>
        <form  method="POST" enctype="multipart/form-data">
            <div class="mb-2">
                <label for="email" class="form-label">รูปภาพ</label>
                <input type="file"  name="image" class="form-control" placeholder="" value="" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password"  name="pass" class="form-control" placeholder="" value="<?=$row['password'];?>" required>
            </div>
            <div class="mt-4">
...
if(isset($_POST['submit'])){
 ...
 $pass =$_POST['pass'];
        ...
        if(in_array($ext ,['jfif','jpg','jpeg','png'])){
            ...
            $stmt =$conn->prepare('UPDATE admin SET Fname= ? ,Lname=?, image=?,phone=? , email=? ,password=? WHERE id=?');
