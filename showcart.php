...
<head>
    ...
    <style>
        .profile-header {
            background: linear-gradient(to right,rgb(156, 55, 27),rgb(163, 45, 45));
            color: white;
            padding: 70px 35px;
            text-align: center;
            position: relative;
...
<body>
    ...
    <div class="profile-header">
        <div class="container">
            ...
            <div class="profile-pic-container">
                <img src="uploads/<?=$row['image'];?>" alt="Profile Picture" class="profile-pic">
            </div>
        </div>
    </div>
    <!-- Tabs -->
    <div class="tab-section container shadow-sm">
        <ul class="nav nav-tabs">
            <li class="nav-item ml-5 mr-4">
                <a class="nav-link active" href="showcart.php" style="color: #000; text-decoration: none;">รายการอาหารทั้งหมด</a>
            </li>
            <li class="nav-item ml-5 mr-4">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9">
                        <div class="row">
                            ...
                            $stmt = $conn->prepare('SELECT * FROM product WHERE res_id = ?');
                            $stmt->execute([$id]);
                            ...
                            <div class="col-6 col-md-3 mb-4">
                                <div class="card shadow-sm  bg-white rounded h-100">
                                    <a href="showreviews.php?id=<?=$product['id'];?>">
                                        <img src="uploads/<?=$product['image'];?>" style="height: 10rem; object-fit: cover;" class="card-img-top rounded">
                                    </a>
                                    <div class="card-body">
                                        <h4><?=$product['name'];?></h4>
                                        <h7>ราคา: <?=$product['price'];?></h7>
                                    </div>
                                    <div class="card-footer bg-white border-0 text-end">
                                        <button id="addToCartBtn" data-product-index="<?= $index; ?>" class="btn btn-success w-100">
                    ...
                    <div class="col-12 col-md-3">
                        <div class="cart-container shadow p-3 mb-5 bg-white rounded">
                            ...
                            <div class="cart-footer">
                                <div class="total">
                                    <p>รวม: ฿<span id="totalPrice">0</span></p>
                                </div>
    ...
    <script>
        ...
        document.querySelectorAll('#addToCartBtn').forEach((item, index) => {
        ...
        function updateCart() {
            ...
            Object.keys(cart).forEach(index => {
                ...
                cartItems.innerHTML += `
                    <div class="cart-item">
                        <div class="item-info">
                            <img src="uploads/${product.image}" width="60" height="60" class="item-image" />
                            <div>
                                <p>${product.name}</p>
                        ...
                        <div>
                            ...
                            <button onclick="removeFromCart(${index})" class="btn btn-danger btn-sm">ลบ</button>
                        </div>
                    </div>
                `;
            });
